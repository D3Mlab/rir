...
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --least_similar --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```
- --least_similar select least similar pairs as positives pairs for each item (restaurant)
### Same Rating Positives
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --same_rating  --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```
- --same_rating select same rating pairs as positives pairs for each item (restaurant)
### Same Rating and Least Similar Positives
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --least_similar --same_rating --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```

### Hard Negatives
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --hard_negative --hard_negative_num 1 --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```
...
### IR Style Training 
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --patience 8 --ir_style --ir_sampling_type 'RC' --true_labels_path './data/PMD.csv' --change_seed --repeat 5
```
...
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --subsample_query --positive_pair_per_restaurant 100 --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```
- --subsample_query subsamples the query to a span in the training
#### Anchor Subsampling (Sentence)
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --subsample_query_sentence --positive_pair_per_restaurant 100 --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```
- subsample_query_sentence subsamples the query to a sentence in the training

#### Prepending Meta Data (PPMD)
```commandline
python ./rir/trainer_cmd.py --tpu --epochs 50 --run_neuralpm --prepend_neuralpm --patience 8 --change_seed --repeat 5 --true_labels_path './data/PMD.csv'
```
...
```commandline
python ./rir/save_warmups.py --tpu 
```

### Learning Item Embedding
```commandline
python ./rir/trainer_cmd.py --tpu --item_embedding --warmup --warmup_weights './item_embeddings_BERT.pickle' --epochs 50 --positive_pair_per_restaurant 300 --run_neuralpm --patience 8
```
...
### BM25
```commandline
python ./rir/runner_BM25.py  --true_labels_path './data/PMD.csv' 
```

### TF IDF
```commandline
python ./rir/runner_cmd.py --tf_idf --true_labels_path './data/PMD.csv' 
```
