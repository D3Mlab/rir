...
class ReviewPreferenceMatching:
    def __init__(self, restaurants, id_name_map, save_directory, split_sentence=False, cosine=False, seed=None,
                 subsample=False, n=1):
        """
        ...
        if subsample:
            print('Subsampling...', 'seed', seed, 'n', n)
